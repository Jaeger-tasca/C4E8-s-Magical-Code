...
import dev.c4e8.mod.modules.impl.client.Colors;
...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(C4E8.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = C4E8.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = C4E8.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
