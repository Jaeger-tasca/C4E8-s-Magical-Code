...
import dev.c4e8.api.utils.entity.MovementUtil;
import dev.c4e8.api.utils.math.Timer;
import dev.c4e8.api.utils.world.BlockUtil;
import dev.c4e8.asm.accessors.ILivingEntity;
...
import dev.c4e8.mod.modules.impl.combat.KillAura;
import dev.c4e8.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        C4E8.ROTATION.snapAt(C4E8.ROTATION.lastYaw, 89);
                    ...
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                C4E8.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            C4E8.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = C4E8.ROTATION.getRotation(pos.toCenterPos())[0];
