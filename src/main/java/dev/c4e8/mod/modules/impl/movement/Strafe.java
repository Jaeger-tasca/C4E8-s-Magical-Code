...
import static dev.c4e8.api.utils.entity.MovementUtil.directionSpeed;
...
public class Strafe
    ...
    public void onStrafe(MoveEvent event) {
        ...
        if (mc.player.isSneaking() || HoleSnap.INSTANCE.isOn() || Speed.INSTANCE.isOn() || mc.player.isFallFlying() || C4E8.PLAYER.insideBlock || mc.player.isInLava() || mc.player.isTouchingWater() || mc.player.getAbilities().flying)
            return;
