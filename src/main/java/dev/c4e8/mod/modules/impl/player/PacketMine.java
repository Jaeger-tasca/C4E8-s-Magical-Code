...
import dev.c4e8.api.events.impl.ClickBlockEvent;
...
import dev.c4e8.api.utils.math.Easing;
...
import dev.c4e8.mod.modules.impl.combat.AutoAnchor;
import dev.c4e8.mod.modules.impl.combat.AutoCev;
import dev.c4e8.mod.modules.impl.combat.AutoCrystal;
import dev.c4e8.mod.modules.settings.SwingSide;
import dev.c4e8.mod.modules.settings.impl.*;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = C4E8.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
