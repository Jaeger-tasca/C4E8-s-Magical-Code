...
import dev.c4e8.core.impl.ShaderManager;
...
public class Shader extends Module {
    ...
    public boolean shouldRender(Entity entity) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if (C4E8.FRIEND.isFriend((PlayerEntity) entity))
    ...
    public void onRender3D(MatrixStack matrixStack) {
        if (hands.getValue())
            C4E8.SHADER.renderShader(()-> mc.gameRenderer.renderHand(matrixStack, mc.gameRenderer.getCamera(), mc.getTickDelta()), mode.getValue());
    }

    @Override
    public void onToggle() {
        C4E8.SHADER.reloadShaders();
    }
