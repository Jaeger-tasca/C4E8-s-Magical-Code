...
public class PopCounter
    ...
    public void onPlayerDeath(DeathEvent event) {
        ...
        if (C4E8.POP.popContainer.containsKey(player.getName().getString())) {
            int l_Count = C4E8.POP.popContainer.get(player.getName().getString());
            if (l_Count == 1) {
    ...
    public void onTotem(TotemEvent event) {
        ...
        int l_Count = 1;
        if (C4E8.POP.popContainer.containsKey(player.getName().getString())) {
            l_Count = C4E8.POP.popContainer.get(player.getName().getString());
        }
        if (l_Count == 1) {
            if (player.equals(mc.player)) {
