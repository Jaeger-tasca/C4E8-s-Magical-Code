...
public class HoleSnap extends Module {
   ...
   private final SliderSetting priority = add(new SliderSetting("Priority", 10,0 ,100, grim::getValue));
    ...
    public void onEnable() {
        ...
        resetMove = false;
        holePos = C4E8.HOLE.getHole((float) range.getValue(), true, any.getValue(), up.getValue());
    }
    ...
    public void onUpdate() {
        ...
        if (C4E8.HOLE.isDoubleHole(holePos)) {
            Direction facing = C4E8.HOLE.is3Block(holePos);
            if (facing != null) {
