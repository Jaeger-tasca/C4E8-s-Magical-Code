...
import dev.c4e8.asm.accessors.IEntityVelocityUpdateS2CPacket;
import dev.c4e8.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = C4E8.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !C4E8.PLAYER.insideBlock)) {
