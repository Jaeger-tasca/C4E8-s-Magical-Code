...
public class ClientSetting extends Module {
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", "C4E8 love you\uD83D\uDC95\uD83D\uDC95", () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[C4E8]", () -> page.getValue() == Page.Notification));
