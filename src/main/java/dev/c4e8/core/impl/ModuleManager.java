...
import dev.c4e8.mod.Mod;
import dev.c4e8.mod.gui.clickgui.ClickGuiScreen;
import dev.c4e8.mod.modules.Module;
import dev.c4e8.mod.modules.impl.client.*;
import dev.c4e8.mod.modules.impl.combat.*;
import dev.c4e8.mod.modules.impl.exploit.*;
import dev.c4e8.mod.modules.impl.misc.*;
import dev.c4e8.mod.modules.impl.movement.*;
import dev.c4e8.mod.modules.impl.player.*;
import dev.c4e8.mod.modules.impl.player.freelook.FreeLook;
import dev.c4e8.mod.modules.impl.render.*;
import dev.c4e8.mod.modules.settings.Setting;
import dev.c4e8.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        C4E8.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
