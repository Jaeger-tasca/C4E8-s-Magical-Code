...
import dev.c4e8.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : C4E8.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : C4E8.MODULE.modules) {
			...
			module.setState(C4E8.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + C4E8.PREFIX);

			for (ClickGuiTab tab : C4E8.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + C4E8.GUI.armorHud.getX());
			printwriter.println("armor_y:" + C4E8.GUI.armorHud.getY());
			...
			System.out.println("[" + C4E8.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + C4E8.NAME + "] Failed to load settings");
		}
	}
