...
import dev.c4e8.api.interfaces.IChatHudHook;
import dev.c4e8.api.utils.Wrapper;
import dev.c4e8.mod.commands.Command;
import dev.c4e8.mod.commands.impl.*;
...
public class CommandManager implements Wrapper {
    ...
    public void command(String[] commandIn) {
        ...
        Command command = commands.get(commandIn[0].substring(C4E8.PREFIX.length()).toLowerCase());
