package dev.c4e8.api.utils.combat;
...
public class CombatUtil implements Wrapper {
    ...
    public static void attackCrystal(Entity crystal, boolean rotate, boolean usingPause) {
        ...
        if (crystal != null) {
            ...
            if (rotate && AntiCheat.INSTANCE.attackRotate.getValue()) C4E8.ROTATION.lookAt(new Vec3d(crystal.getX(), crystal.getY() + 0.25, crystal.getZ()));
    ...
    public static boolean isValid(Entity entity, double range) {
        boolean invalid = entity == null || !entity.isAlive() || entity.equals(mc.player) || entity instanceof PlayerEntity player && C4E8.FRIEND.isFriend(player) || mc.player.getPos().distanceTo(entity.getPos()) > range;
